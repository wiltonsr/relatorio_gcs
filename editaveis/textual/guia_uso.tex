...
\flushleft{ 
  \textbf{svnadmin create <camminho do repositorio>}
}
\end{minipage}
}
...
\begin{table}[]
\centering
\caption{Comparação entre os servidores}
\label{tab:servidores}
\begin{tabular}{|l|l|l|l|}
\hline
\rowcolor[HTML]{01796F} 
{\color[HTML]{000000} \textbf{Característica}} & {\color[HTML]{000000} \textbf{Apache + mod\_dav\_svn}}                                                                                                                   & {\color[HTML]{000000} \textbf{svnserve}}                                                                                                     & {\color[HTML]{000000} \textbf{svnserve sobre SSH}}                             \\ \hline
Opções de autenticação                         & \begin{tabular}[c]{@{}l@{}}Autenticação básica HTTP(S), certificados \\ X.509, LDAP, NTLM, ou quaisquer \\ outros mecanismos disponíveis \\ ao Apache httpd\end{tabular} & CRAM-MD5                                                                                                                                     & SSH                                                                            \\ \hline
Opções para contas de usuários                 & arquivo 'users' privativo                                                                                                                                                & arquivo 'users' privativo                                                                                                                    & contas no sistema                                                              \\ \hline
Opções de autorização                          & \begin{tabular}[c]{@{}l@{}}acesso leitura/escrita pode ser dado\\ para o repositório como um \\ todo, ou especificado por caminho\end{tabular}                           & \begin{tabular}[c]{@{}l@{}}acesso leitura/escrita pode ser dado \\ para o repositório como um todo, ou especificado por caminho\end{tabular} & acesso leitura/escrita passível de ser dado apenas ao repositório como um todo \\ \hline
...
Interoperabilidade                             & \begin{tabular}[c]{@{}l@{}}parcialmente usável por outros \\ clientes WebDAV\end{tabular}                                                                                & se comunica apenas com clientes svn                                                                                                          & se comunica apenas com clientes svn                                            \\ \hline
Visualização pela web                          & \begin{tabular}[c]{@{}l@{}}suporte existente limitado, ou também \\ por meio de ferramentas de terceiros \\ como o ViewVC\end{tabular}                                   & apenas por meio de ferramentas de terceiros como o ViewVC                                                                                    & apenas por meio de ferramentas de terceiros como o ViewVC                      \\ \hline
Velocidade                                     & um pouco mais lento                                                                                                                                                      & um pouco mais rápido                                                                                                                         & um pouco mais rápido                                                           \\ \hline
