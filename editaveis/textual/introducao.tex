...
\section{Funções gerais}
  ...
  A seguir serão descritas as funções que do SVN de acordo com o \citeonline{svn-book}:
...
\section{Versões disponíveis}
  ...
  \begin{itemize}
    \item \textit{Subversion} 1.9.2 \footnotemark \footnotetext{Disponível em: \url{https://subversion.apache.org/download.cgi}.}

    \item \textit{Subversion} 1.8.14 \footnotemark \footnotetext{Disponível em: \url{https://subversion.apache.org/download.cgi}.}
