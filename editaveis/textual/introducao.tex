...
\section{Versões disponíveis}
  ...
  \begin{itemize}
    \item Subversion 1.9.2 \footnotemark \footnotetext{Disponível em: \url{https://subversion.apache.org/download.cgi}.}

    \item Subversion 1.8.14 \footnotemark \footnotetext{Disponível em: \url{https://subversion.apache.org/download.cgi}.}
